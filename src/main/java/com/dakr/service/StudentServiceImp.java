...
import com.dakr.repository.StudentRegistrationRepository;
...
public class StudentServiceImp implements StudentService{
	...
	@Override
	public boolean signUp(StudentRegistrationBinding form) {
		StudentRegistration findByEmail = repo.findByEmail(form.getEmail());
		if (findByEmail != null) {
			return false;
		}
	...
	@Override
	public boolean unlockFormAccount(StudentUnlockForm form) {
		StudentRegistration entity = repo.findByEmail(form.getEmail());
	...
	public String loginForm(StudentLoginForm form) {
		StudentRegistration entity = repo.findByEmailAndPassword(form.getEmail(), form.getPwd());
		if (entity == null) {
		...
		session.setAttribute("userId", entity.getStuId());
		return "success";
	...
	public boolean forgotPwd(String email) {
		// check Record Presence in db with given mail
				StudentRegistration entity = repo.findByEmail(email);
